          ...
          <div className="card">
            <table className="table">
              ...
              <tbody>
                ...
                {!safeSlas.length && <tr><td colSpan={6} style={{ textAlign: 'center', color: '#64748b' }}>No SLA policies defined</td></tr>}
              </tbody>
            </table>
          </div>
        </div>
        ...
        <div className="card">
          <table className="table">
            ...
            <tbody>
              ...
              {!safeViolations.length && <tr><td colSpan={6} style={{ textAlign: 'center', color: '#64748b' }}>No violations found — run a scan</td></tr>}
            </tbody>
          </table>
        </div>
      )}
