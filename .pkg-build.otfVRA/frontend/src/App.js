...
const LocalRepoOpsPage = React.lazy(() => import('./LocalRepoOpsPageStitch'));
const MirrorRepoOpsPage = React.lazy(() => import('./MirrorRepoOpsPageStitch'));
...
const BackupManagerPageView = React.lazy(() => import('./BackupManagerPageStitch'));
const ProvisioningPageView = React.lazy(() => import('./ProvisioningPageStitch'));
const NetworkBootPageView = React.lazy(() => import('./NetworkBootPageStitch'));
...
const OpsQueuePageView = React.lazy(() => import('./OpsQueuePageStitch'));
...
function App() {
  ...
  const navItems = [
    ...
    ...(hasPerm('testing') ? [{ key: 'stitch-demo', label: 'Stitch UI Builder', icon: 'code' }] : []),
  ...
  const showExpiringSoonBanner = Boolean(
    licenseInfo && licenseInfo.valid && !licenseInfo.expired && licenseInfo.days_remaining <= 30
  );
  const topBannerOffset = showExpiringSoonBanner ? 44 : 0;
  ...
  return (
    <ToastContext.Provider value={toast}>
      ...
      {showExpiringSoonBanner && (
        <div style={{position:'fixed',top:0,left:0,right:0,background:'#ffc107',color:'#000',padding:'10px 20px',textAlign:'center',fontWeight:600,cursor:'pointer',zIndex:9999}} onClick={()=>setPage('license')}>
      ...
      <StitchShell
        ...
        onRefresh={fetchAll}
        toast={toast}
        topBannerOffset={topBannerOffset}
      >
