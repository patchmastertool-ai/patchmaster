...
- **Universal Multi-OS Support**: Native agents for ALL major platforms:
  - Linux: Debian/Ubuntu, RHEL/Rocky/Alma/CentOS, Fedora, Arch/Manjaro, openSUSE, Alpine
  - BSD: FreeBSD
  - Cloud: Amazon Linux 2/2023
...
**🎉 100% Platform Coverage - NO Limitations!**
...
- Detects ALL operating systems (Debian/Ubuntu, RHEL/Rocky/Alma/Fedora, Arch Linux, openSUSE, Alpine, FreeBSD)
...
**Artifacts:**
- `dist/patchmaster-2.0.0.tar.gz`: The core product for customers.
...
PIP_OPTS="--no-index" OFFLINE=1 PIP_DISABLE_PIP_VERSION_CHECK=1 bash packaging/build-package.sh --output dist/
