...
ALGORITHM = "HS256"
ACCESS_TOKEN_EXPIRE_MINUTES = int(os.getenv("TOKEN_EXPIRE_MINUTES", "15"))  # 15 min (was 480)
...
def _derive_fernet_key() -> bytes:
    ...
    import base64
    raw_key = os.getenv("PM_SECRET_KEY", "ZGV2LW9ubHktZmVybmV0LWtleS1kb25vdC11c2UtaW4tcHJvZA==").encode()
